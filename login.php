...
<html lang="en">
    ...
    <body class="contact">
        ...
        <div class="log" style="height: 500px;padding: 10px;">
            <h2>Login</h2>
            <div class="mb-3 my-5"> 
                Email id : <input
            ...
            <?php
               if(isset($_POST['email'])){
                   ...
                   if($con->query($sql) == true){
                       echo "<div><b>Successfully logged in</b></div>";
                       echo "<script>setTimeout(() => {window.location.assign('myweb.html');}, 2000);</script>";
                   }else{
                       echo "Error Occured";
                   }
               }
